...
| Retrospective | 회고 생성/조회/삭제 | 선택 기간의 Diary 또는 DailyContext, DailyChatSession, persona.md를 기반으로 회고 글 생성·조회 및 삭제 |
...
| 3-5 | Memo 요약 생성 | 사용자는 Memo의 요약하기를 실행할 수 있어야 한다. AI는 현재 DRAFT Memo 전체 내용을 분석하여 카테고리별 MemoSummary를 생성해야 한다. 하나의 기록은 여러 MemoSummary에 반영될 수 있으며, 여러 기록은 하나의 MemoSummary로 통합될 수 있다. |
...
| 6-4 | 회고 삭제 | 사용자는 자신이 생성한 Retrospective를 삭제할 수 있어야 한다. 삭제된 Retrospective는 상세·목록 조회에서 제외되어야 하며, 다른 사용자의 Retrospective는 삭제할 수 없어야 한다. |
