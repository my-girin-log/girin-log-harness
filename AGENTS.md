...
- **06:00 KST에 Memo 원본·DailyChatSession 기반 Diary 자동 생성 + 일일 작업 공간 초기화**. MemoSummary는 있을 때만 보조 힌트로 참고한다. 오늘 회고 생성에는 아직 Diary가 없고 내용 있는 Memo가 있는 현재 serviceDate의 Memo 원본을 임시 DailyContext로 사용할 수 있다.
