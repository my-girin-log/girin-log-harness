...
- **06:00 KST에 Memo 원본·DailyChatSession 기반 Diary 자동 생성 + 일일 작업 공간 초기화**. MemoSummary는 있을 때만 보조 힌트로 참고한다. 자동 생성이 누락된 과거 서비스 날짜는 사용자가 수동 생성할 수 있다.
...
- Retrospective 생성에 원본 Memo, MemoSummary를 다시 직접 넣기 → 회고 생성 입력은 **Diary + DailyChatSession conversation + persona.md** 다.
